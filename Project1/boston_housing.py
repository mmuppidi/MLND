...
def explore_city_data(city_data):
    ...
    print "Size of the data : ",housing_features.shape[0]
    # Number of features?
    print "Number of features: ",housing_features.shape[1]
    # Minimum price?
    print "Minimum prices: ", min(housing_prices)
    # Maximum price?
    print "Maximum prices: ", max(housing_prices)
    # Calculate mean price?
    print "Mean of the prices: ", np.mean(housing_prices)
    # Calculate median price?
    print "Median of the prices: ", np.median(housing_prices)
    # Calculate standard deviation?
    print "Standard deviation of the prices: ",np.std(housing_prices)
